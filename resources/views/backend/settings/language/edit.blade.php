                                    ...
                                    <form action="{{route('languages.update',$languageSingle->id)}}" method="POST">
                                        ...
                                        @method('PATCH')
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" id="name" name="name" class="form-control" value="{{old('name',$languageSingle->name)}}" placeholder="{{translate('Enter Name')}}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="code" class="form-label">{{translate('Code')}} <span class="text-danger">*</span></label>
                                                                @php
                                                                    $languagesArray = \App\Models\Language::where('code','<>',$languageSingle->code)->pluck('code')->toarray();
                                                                @endphp
                                                                <!-- Multiple Select -->
