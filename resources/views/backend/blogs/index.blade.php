                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <a href="{{route('blogs.create')}}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-thick me-2"></i> Add Blog</a>
                                            </div>
                                            <div class="col-sm-7">
                                                    ...
                                                    <table class="table table-hover text-center table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);" class="btn btn-sm btn-outline-primary"> <i class="mdi mdi-eye"></i></a>
